...
namespace UnityTest {
    ...
    public class IntegrationTestsRunnerWindow : EditorWindow, IHasCustomMenu {
        ...
        private static void SelectInHierarchy(GameObject gameObject) {
            ...
            List<Component> skipList = gameObject.GetComponentsInChildren(typeof (TestComponent), true).ToList();
        ...
        private void RunTests(IList<ITestComponent> tests) {
            ...
            List<TestComponent> testComponents = tests.Where(t => t is TestComponent).Cast<TestComponent>().ToList();
            List<TestComponent> dynaminTests = testComponents.Where(t => t.dynamic).ToList();
        ...
        public void Update() {
            if (m_ReadyToRun && EditorApplication.isPlaying) {
                ...
                List<TestComponent> testComponents =
                    m_TestsToRun.Select(go => go.GetComponent<TestComponent>()).ToList();
        ...
        private void RebuildTestList() {
            ...
            List<TestResult> newResultList = new List<TestResult>();
        ...
        private IntegrationTestRendererBase[] ParseTestList(List<TestComponent> testList, List<TestResult> results) {
            List<IntegrationTestRendererBase> tempList = new List<IntegrationTestRendererBase>();
        ...
        private bool PrintTestList(IntegrationTestRendererBase[] renderedLines) {
            ...
            RenderingOptions filter = m_FilterSettings.BuildRenderingOptions();
        ...
        private void RenderDetails() {
            ...
            EditorGUILayout.SelectableLabel(m_resultText,
                                            Styles.info,
        ...
        [SerializeField]
        private List<GameObject> m_TestsToRun;
        ...
        private Vector2 m_resultTextSize;
        private string m_resultText;
        private GameObject m_lastSelectedGO;
        private int m_resultTestMaxLength = 15000;
