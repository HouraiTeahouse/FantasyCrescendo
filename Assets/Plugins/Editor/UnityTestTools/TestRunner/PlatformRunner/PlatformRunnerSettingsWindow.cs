...
namespace UnityTest.IntegrationTests {
    ...
    public class PlatformRunnerSettingsWindow : EditorWindow {
        ...
        private readonly GUIContent m_Label = new GUIContent("Results target directory",
        ...
        private void DrawSetting() {
            ...
            if (GUILayout.Button("Search", EditorStyles.miniButton, GUILayout.Width(50))) {
                string selectedPath = EditorUtility.SaveFolderPanel("Result files destination",
            ...
            m_Settings.sendResultsOverNetwork = EditorGUILayout.Toggle("Send results to editor",
                                                                       m_Settings.sendResultsOverNetwork);
            EditorGUI.BeginDisabledGroup(!m_Settings.sendResultsOverNetwork);
            m_AdvancedNetworkingSettings = EditorGUILayout.Foldout(m_AdvancedNetworkingSettings,
                                                                   "Advanced network settings");
            if (m_AdvancedNetworkingSettings) {
                m_SelectedInterface = EditorGUILayout.Popup("Network interface",
                                                            m_SelectedInterface,
