    ...
    public class AssertionComponentEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (obj) {
                ...
                m_ThisPathSelector.Draw(script.Action.go,
                                        script.Action,
        ...
        private void DrawObjectCompareField(ComparerBase comparer) {
            m_OtherPathSelector.Draw(comparer.other,
                                     comparer,
        ...
        private bool DrawComparerSelection(AssertionComponent script) {
            ...
            m_ComparerDropDown.Draw(script.Action.GetType(),
                                    allComparers,
                                    type => {
        ...
        private readonly GUIContent m_GUICheckAfterTimeGuiContent = new GUIContent("Check after (seconds)",
                                                                                   "After how many seconds the assertion should be checked");

        private readonly GUIContent m_GUIRepeatCheckTimeGuiContent = new GUIContent("Repeat check",
                                                                                    "Should the check be repeated.");

        private readonly GUIContent m_GUIRepeatEveryTimeGuiContent = new GUIContent("Frequency of repetitions",
                                                                                    "How often should the check be done");

        private readonly GUIContent m_GUICheckAfterFramesGuiContent = new GUIContent("Check after (frames)",
                                                                                     "After how many frames the assertion should be checked");

        private readonly GUIContent m_GUIRepeatCheckFrameGuiContent = new GUIContent("Repeat check",
                                                                                     "Should the check be repeated.");
