...
namespace UnityTest {
    ...
    public class PropertyPathSelector {
        ...
        private string DrawListOfMethods(GameObject go,
                                         ActionBase comparer,
                                         string propertPath,
                                         Type[] accepatbleTypes,
            ...
            if (accepatbleTypes == null)
                ...
                var isPropertyOrFieldFound = true;
                ...
                if (isPropertyOrFieldFound) {
                    dropDown.Draw(go.name + '.',
                                  ...
                                  () => {
                                      try {
                                          List<string> options = GetFieldsAndProperties(go,
                                                                                        comparer,
                                                                                        result,
                                                                                        accepatbleTypes);
        ...
        private static List<string> GetFieldsAndProperties(GameObject go,
                                                           ActionBase comparer,
                                                           string extendPath,
                                                           Type[] accepatbleTypes) {
        ...
        private string DrawManualPropertyEditField(GameObject go,
                                                   string propertPath,
            ...
            Func<string[]> loadProps = () => {
                                           try {
                                               list =
                                                   propertyResolver.GetFieldsAndPropertiesUnderPath(
                                                                                                    go,
                                                                                                    propertPath);
            ...
            GUILayout.Label(go.name + (propertPath.Length > 0 ? "." : ""),
                            EditorStyles.label,
