...
namespace UnityTest {
    ...
    public class AssertionExplorerWindow : EditorWindow {
            ...
            switch (m_FilterType) {
                ...
                case FilterType.SecondComparedGameObjectPath:
                    return assertionComponents.Where(c =>
                                                     ...
                                                     &&
                                                     (c.Action as ComparerBase).otherPropertyPath.ToLower()
                                                                               .Contains(text));
        ...
        private void DrawMenuPanel() {
            ...
            m_GroupBy =
                (GroupByType) EditorGUILayout.EnumPopup(m_GroupBy, EditorStyles.toolbarPopup, GUILayout.MaxWidth(150));

            GUILayout.FlexibleSpace();

            m_ShowType =
                (ShowType) EditorGUILayout.EnumPopup(m_ShowType, EditorStyles.toolbarPopup, GUILayout.MaxWidth(100));

            EditorGUILayout.LabelField("Filter by:", Styles.toolbarLabel, GUILayout.MaxWidth(50));
            m_FilterType =
                (FilterType) EditorGUILayout.EnumPopup(m_FilterType, EditorStyles.toolbarPopup, GUILayout.MaxWidth(100));
