...
namespace UnityTest {
    ...
    public static class GuiHelper {
        ...
        private static SequencePoint GetSequencePointOfTest(UnitTestResult test) {
            ...
            AssemblyDefinition assemblyDefinition = AssemblyDefinition.ReadAssembly(test.Test.AssemblyPath,
                                                                                    readerParameters);
        ...
        private static void OpenInEditorInternal(string filename, int line) {
            ...
            Object scriptAsset = AssetDatabase.LoadMainAssetAtPath(assetPath);
