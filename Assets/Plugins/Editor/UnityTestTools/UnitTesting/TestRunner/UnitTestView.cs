    ...
    public partial class UnitTestView : EditorWindow, IHasCustomMenu {
        ...
        public void AddItemsToMenu(GenericMenu menu) {
            ...
            if (!m_Settings.runTestOnANewScene)
                ...
                menu.AddItem(m_GUIAutoSaveSceneBeforeRun,
                             m_Settings.autoSaveSceneBeforeRun,
                             m_Settings.ToggleAutoSaveSceneBeforeRun);
            }
        ...
        private void RenderTestList() {
            ...
            if (m_TestLines != null) {
                if (m_TestLines.Render(m_FilterSettings.BuildRenderingOptions()))
                    Repaint();
            }
        ...
        private void RenderTestInfo() {
            ...
            Vector2 resultTextSize = Styles.info.CalcSize(new GUIContent(text));
        ...
        private readonly GUIContent m_GUIRunOnRecompile = new GUIContent("Run on recompile",
                                                                         "Run all tests after recompilation");

        private readonly GUIContent m_GUIShowDetailsBelowTests = new GUIContent("Show details below tests",
                                                                                "Show run details below test list");

        private readonly GUIContent m_GUIRunTestsOnNewScene = new GUIContent("Run tests on a new scene",
                                                                             "Run tests on a new scene");

        private readonly GUIContent m_GUIAutoSaveSceneBeforeRun = new GUIContent("Autosave scene",
