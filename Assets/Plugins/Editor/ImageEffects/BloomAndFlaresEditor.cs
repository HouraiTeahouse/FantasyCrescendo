...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class BloomAndFlaresEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayout.Label(
                            "HDR " +
                            (hdr.enumValueIndex == 0
                                 ? "auto detected, "
                                 : (hdr.enumValueIndex == 1 ? "forced on, " : "disabled, ")) +
                            (useSrcAlphaAsMask.floatValue < 0.1f
                                 ? " ignoring alpha channel glow information"
                                 : " using alpha channel glow information"),
            ...
            bloomBlurIterations.intValue = EditorGUILayout.IntSlider("Blur iterations",
            ...
            if (1 == tweakMode.intValue) {
                ...
                if (lensflares.boolValue) {
                    ...
                    lensflarethreshold.floatValue = EditorGUILayout.Slider("Local threshold",
