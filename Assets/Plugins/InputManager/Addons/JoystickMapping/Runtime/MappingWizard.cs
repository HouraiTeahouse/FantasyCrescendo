...
namespace TeamUtility.IO {
    ...
    public class MappingWizard : MonoBehaviour {
        ...
        [SerializeField]
        private TextAsset _testDefinition = null;
        ...
        private void DisplayCurrentTestItem() {
            string description = string.Format("{0} <b>{1}</b>",
                                               _items[_currentItem].ScanType == ScanType.Button ? "Press" : "Move",
            ...
            GUI.Label(new Rect(Screen.width - 100.0f, Screen.height - 34.0f, 100.0f, 24.0f),
                      (_currentItem + 1) + "/" + _items.Length,
                      "centered_label");
