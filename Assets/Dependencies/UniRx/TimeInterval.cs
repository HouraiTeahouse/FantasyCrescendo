...
namespace UniRx {
    ...
    public struct TimeInterval<T> : IEquatable<TimeInterval<T>> {
        ...
        /// <summary> Determines whether the current TimeInterval&lt;T&gt; value has the same Value and Interval as a specified
        /// TimeInterval&lt;T&gt; value. </summary>
        ...
        /// <summary> Determines whether the two specified TimeInterval&lt;T&gt; values have the same Value and Interval. </summary>
        ...
        /// <returns> true if the first TimeInterval&lt;T&gt; value has the same Value and Interval as the second TimeInterval&lt;T
        /// &gt; value; otherwise, false. </returns>
        public static bool operator ==(TimeInterval<T> first, TimeInterval<T> second) {
            return first.Equals(second);
        }

        /// <summary> Determines whether the two specified TimeInterval&lt;T&gt; values don't have the same Value and Interval. </summary>
        /// <param name="first"> The first TimeInterval&lt;T&gt; value to compare. </param>
        /// <param name="second"> The second TimeInterval&lt;T&gt; value to compare. </param>
        /// <returns> true if the first TimeInterval&lt;T&gt; value has a different Value or Interval as the second TimeInterval
        /// &lt;T&gt; value; otherwise, false. </returns>
        public static bool operator !=(TimeInterval<T> first, TimeInterval<T> second) {
            return !first.Equals(second);
        }

        /// <summary> Determines whether the specified System.Object is equal to the current TimeInterval&lt;T&gt;. </summary>
        ...
        /// <summary> Returns the hash code for the current TimeInterval&lt;T&gt; value. </summary>
        ...
        /// <summary> Returns a string representation of the current TimeInterval&lt;T&gt; value. </summary>
