...
namespace UniRx {
    ...
    /// <summary> Lightweight property broker. </summary>
    [Serializable]
        ...
        public T Value {
            ...
            set {
                if (!canPublishValueOnSubscribe) {
                    ...
                    if (isDisposed)
                        return; // don't notify but set value
    ...
    public class ReadOnlyReactiveProperty<T> : IReadOnlyReactiveProperty<T>, IDisposable, IOptimizedObservable<T> {
        ...
        class ReadOnlyReactivePropertyObserver : IObserver<T> {
            ...
            public ReadOnlyReactivePropertyObserver(ReadOnlyReactiveProperty<T> parent) { this.parent = parent; }
    ...
    /// <summary> Extension methods of ReactiveProperty&lt;T&gt; </summary>
    public static class ReactivePropertyExtensions {
        ...
        /// <summary> Lastest values of each sequence are all true. </summary>
        ...
        /// <summary> Lastest values of each sequence are all false. </summary>
