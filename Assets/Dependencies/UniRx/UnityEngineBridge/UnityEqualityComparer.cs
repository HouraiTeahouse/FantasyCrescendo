...
namespace UniRx {
    ...
    public static class UnityEqualityComparer {
        ...
        class BoundsEqualityComparer : IEqualityComparer<Bounds> {
            ...
            public int GetHashCode(Bounds obj) { return obj.center.GetHashCode() ^ obj.extents.GetHashCode() << 2; }
        ...
        class Vector2EqualityComparer : IEqualityComparer<Vector2> {
            ...
            public int GetHashCode(Vector2 obj) { return obj.x.GetHashCode() ^ obj.y.GetHashCode() << 2; }
