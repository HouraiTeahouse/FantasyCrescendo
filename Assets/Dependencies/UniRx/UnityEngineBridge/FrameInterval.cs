...
namespace UniRx {
    ...
    /// <summary> Represents a value associated with time interval information. The time interval can represent the time it
    /// took to produce the value, the interval relative to a previous value, the value's delivery time relative to a base,
    /// etc. </summary>
    ...
    public struct FrameInterval<T> : IEquatable<FrameInterval<T>> {
        ...
        /// <summary> Determines whether the current FrameInterval&lt;T&gt; value has the same Value and Interval as a specified
        /// FrameInterval&lt;T&gt; value. </summary>
        ...
        /// <summary> Determines whether the two specified FrameInterval&lt;T&gt; values have the same Value and Interval. </summary>
        ...
        /// <returns> true if the first FrameInterval&lt;T&gt; value has the same Value and Interval as the second FrameInterval
        /// &lt;T&gt; value; otherwise, false. </returns>
        public static bool operator ==(FrameInterval<T> first, FrameInterval<T> second) {
            return first.Equals(second);
        }

        /// <summary> Determines whether the two specified FrameInterval&lt;T&gt; values don't have the same Value and Interval. </summary>
        /// <param name="first"> The first FrameInterval&lt;T&gt; value to compare. </param>
        /// <param name="second"> The second FrameInterval&lt;T&gt; value to compare. </param>
        /// <returns> true if the first FrameInterval&lt;T&gt; value has a different Value or Interval as the second FrameInterval
        /// &lt;T&gt; value; otherwise, false. </returns>
        public static bool operator !=(FrameInterval<T> first, FrameInterval<T> second) {
            return !first.Equals(second);
        }

        /// <summary> Determines whether the specified System.Object is equal to the current FrameInterval&lt;T&gt;. </summary>
        ...
        /// <summary> Returns the hash code for the current FrameInterval&lt;T&gt; value. </summary>
        ...
        /// <summary> Returns a string representation of the current FrameInterval&lt;T&gt; value. </summary>
