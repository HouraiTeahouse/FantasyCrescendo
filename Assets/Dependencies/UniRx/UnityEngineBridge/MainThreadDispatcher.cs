...
namespace UniRx {
    ...
    public sealed class MainThreadDispatcher : MonoBehaviour {
        ...
        class EditorThreadDispatcher {
            ...
            EditorThreadDispatcher() { EditorApplication.update += Update; }
            ...
            public void Enqueue(Action<object> action, object state) { editorQueueWorker.Enqueue(action, state); }
            ...
            void Update() { editorQueueWorker.ExecuteAll(x => Debug.LogException(x)); }
                ...
                if (routine.MoveNext()) {
                    ...
                    if (type == typeof(AsyncOperation)) {
                        ...
                        editorQueueWorker.Enqueue(
                            _ => ConsumeEnumerator(UnwrapWaitAsyncOperation(asyncOperation, routine)),
                            null);
                        return;
                    }
        ...
        public enum CullingMode {
            ...
            /// <summary> Won't remove any MainThreadDispatchers. </summary>
            Disabled,

            /// <summary> Checks if there is an existing MainThreadDispatcher on Awake(). If so, the new dispatcher removes itself. </summary>
            Self,

            /// <summary> Search for excess MainThreadDispatchers and removes them all on Awake(). </summary>
            All
            ...
            if (mainThreadToken != null) {
                ...
                if (!isQuitting && !ReferenceEquals(dispatcher, null)) {
                    dispatcher.queueWorker.Enqueue(_ => {
                        MainThreadDispatcher distpacher2 = Instance;
                        if (distpacher2 != null) {
