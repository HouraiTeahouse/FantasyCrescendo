...
namespace UniRx {
    ...
    public static partial class ObserveExtensions {
        ...
        /// <summary> Publish target property when value is changed. If source is destroyed/destructed, publish OnCompleted. </summary>
        public static IObservable<TProperty> ObserveEveryValueChanged<TSource, TProperty>(this TSource source,
            ...
            where TSource : class {
            return ObserveEveryValueChanged(source,
                propertySelector,
                frameCountType,
                UnityEqualityComparer.GetDefault<TProperty>());
        }
            ...
            if (isUnityObject) {
                return ObservableUnity.FromMicroCoroutine<TProperty>((observer, cancellationToken) => {
                    if (unityObject != null) {
                        ...
                        return PublishUnityObjectValueChanged(unityObject,
                            firstValue,
                            propertySelector,
                            comparer,
                            observer,
                ...
                return ObservableUnity.FromMicroCoroutine<TProperty>((observer, cancellationToken) => {
                    ...
                    if (target != null) {
                        ...
                        observer.OnNext(firstValue);
                        return PublishPocoValueChanged(reference,
                            firstValue,
                            propertySelector,
                            comparer,
                            observer,
        ...
        static IEnumerator PublishUnityObjectValueChanged<TSource, TProperty>(Object unityObject,
                                                                              TProperty firstValue,
                                                                              Func<TSource, TProperty> propertySelector,
                                                                              IEqualityComparer<TProperty> comparer,
                                                                              IObserver<TProperty> observer,
