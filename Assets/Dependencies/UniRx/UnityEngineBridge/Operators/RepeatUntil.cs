    ...
    internal class RepeatUntilObservable<T> : OperatorObservableBase<T> {
        ...
        class RepeatUntil : OperatorObserverBase<T, T> {
            ...
            public IDisposable Run() {
                ...
                return new CompositeDisposable(schedule,
                    subscription,
                    stopper,
                    Disposable.Create(() => {
                        lock (gate) {
            ...
            void RecursiveRun(Action self) {
                lock (gate) {
                    ...
                    if (isFirstSubscribe) {
                        ...
                        MainThreadDispatcher.SendStartCoroutine(SubscribeAfterEndOfFrame(d,
                            source,
                            this,
            ...
            static IEnumerator SubscribeAfterEndOfFrame(SingleAssignmentDisposable d,
        ...
        public RepeatUntilObservable(IEnumerable<IObservable<T>> sources,
                                     IObservable<Unit> trigger,
                                     GameObject lifeTimeChecker) : base(true) {
