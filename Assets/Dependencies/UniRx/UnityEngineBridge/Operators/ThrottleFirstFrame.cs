    ...
    internal class ThrottleFirstFrameObservable<T> : OperatorObservableBase<T> {
        ...
        class ThrottleFirstFrame : OperatorObserverBase<T, T> {
            ...
            class ThrottleFirstFrameTick : IObserver<long> {
                ...
                public ThrottleFirstFrameTick(ThrottleFirstFrame parent) { this.parent = parent; }
            ...
            public override void OnNext(T value) {
                ...
                d.Disposable = UnityObservable.TimerFrame(parent.frameCount, parent.frameCountType).Subscribe(tick);
            }
