...
namespace UniRx {
    ...
    public struct CollectionAddEvent<T> : IEquatable<CollectionAddEvent<T>> {
        ...
        public CollectionAddEvent(int index, T value) : this() {
            Index = index;
            Value = value;
        }

        public override string ToString() { return string.Format("Index:{0} Value:{1}", Index, Value); }
    ...
    public struct CollectionRemoveEvent<T> : IEquatable<CollectionRemoveEvent<T>> {
        ...
        public CollectionRemoveEvent(int index, T value) : this() {
            Index = index;
            Value = value;
        }
    ...
    public struct CollectionMoveEvent<T> : IEquatable<CollectionMoveEvent<T>> {
        ...
        public CollectionMoveEvent(int oldIndex, int newIndex, T value) : this() {
            OldIndex = oldIndex;
            NewIndex = newIndex;
            Value = value;
        }
    ...
    public struct CollectionReplaceEvent<T> : IEquatable<CollectionReplaceEvent<T>> {
        ...
        public CollectionReplaceEvent(int index, T oldValue, T newValue) : this() {
            Index = index;
            OldValue = oldValue;
            NewValue = newValue;
        }
        ...
        public bool Equals(CollectionReplaceEvent<T> other) {
            return Index.Equals(other.Index) && EqualityComparer<T>.Default.Equals(OldValue, other.OldValue)
