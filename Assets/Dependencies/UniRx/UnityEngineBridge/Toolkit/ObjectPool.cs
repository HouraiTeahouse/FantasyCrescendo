...
namespace UniRx.Toolkit {
    ...
    /// <summary> Bass class of ObjectPool. </summary>
    public abstract class ObjectPool<T> : IDisposable where T : Component {

        bool disposedValue = false;
        Queue<T> q;

        /// <summary> Limit of instace count. </summary>
        protected int MaxPoolCount {
            get { return int.MaxValue; }
        }

        /// <summary> Current pooled object count. </summary>
        public int Count {
            get {
                if (q == null)
                    return 0;
        ...
        /// <summary> Create instance when needed. </summary>
        protected abstract T CreateInstance();

        /// <summary> Called before return to pool, useful for set active object(it is default behavior). </summary>
        protected virtual void OnBeforeRent(T instance) {
            instance.gameObject.SetActive(true);
        }

        /// <summary> Called before return to pool, useful for set inactive object(it is default behavior). </summary>
        protected virtual void OnBeforeReturn(T instance) {
            instance.gameObject.SetActive(false);
        }

        /// <summary> Called when clear or disposed, useful for destroy instance or other finalize method. </summary>
        ...
        /// <summary> Get instance from pool. </summary>
        public T Rent() {
            if (disposedValue)
            ...
            T instance = q.Count > 0 ? q.Dequeue() : CreateInstance();
        ...
        /// <summary> Trim pool instances. </summary>
        ...
        /// <summary> If needs shrink pool frequently, start check timer. </summary>
        ...
        public IObservable<Unit> PreloadAsync(int preloadCount, int threshold) {
            ...
            return
                Observable.FromMicroCoroutine<Unit>(
                    (observer, cancel) => PreloadCore(preloadCount, threshold, observer, cancel));
        }

        IEnumerator PreloadCore(int preloadCount,
                                int threshold,
    ...
    /// <summary> Bass class of ObjectPool. If needs asynchronous initialization, use this instead of standard ObjectPool. </summary>
    public abstract class AsyncObjectPool<T> : IDisposable where T : Component {
        ...
        IEnumerator PreloadCore(int preloadCount,
            ...
            while (Count < preloadCount && !cancellationToken.IsCancellationRequested) {
                ...
                ObservableYieldInstruction<Unit> awaiter = Observable.WhenAll(loaders)
                    .ToYieldInstruction(false, cancellationToken);
