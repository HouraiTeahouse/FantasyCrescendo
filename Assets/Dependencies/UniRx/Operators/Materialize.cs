...
namespace UniRx.Operators {
    ...
    internal class MaterializeObservable<T> : OperatorObservableBase<Notification<T>> {
        ...
        class Materialize : OperatorObserverBase<T, Notification<T>> {
            ...
            public override void OnNext(T value) { observer.OnNext(Notification.CreateOnNext(value)); }
        ...
        public MaterializeObservable(IObservable<T> source) : base(source.IsRequiredSubscribeOnCurrentThread()) {
            this.source = source;
        }
