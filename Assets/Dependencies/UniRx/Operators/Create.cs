...
namespace UniRx.Operators {
    ...
    internal class CreateObservable<T> : OperatorObservableBase<T> {
        ...
        public CreateObservable(Func<IObserver<T>, IDisposable> subscribe) : base(true) // fail safe
        {
    ...
    internal class CreateObservable<T, TState> : OperatorObservableBase<T> {
        ...
        public CreateObservable(TState state,
                                Func<TState, IObserver<T>, IDisposable> subscribe,
                                bool isRequiredSubscribeOnCurrentThread) : base(isRequiredSubscribeOnCurrentThread) {
            this.state = state;
            this.subscribe = subscribe;
        }
    ...
    internal class CreateSafeObservable<T> : OperatorObservableBase<T> {
        ...
        public CreateSafeObservable(Func<IObserver<T>, IDisposable> subscribe) : base(true) // fail safe
        {
            this.subscribe = subscribe;
        }
