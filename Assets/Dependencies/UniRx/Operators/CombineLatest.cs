...
namespace UniRx.Operators {
    ...
    public delegate TR CombineLatestFunc<T1, T2, T3, T4, T5, T6, TR>(
        T1 arg1,
        T2 arg2,
        T3 arg3,
        T4 arg4,
    ...
    public delegate TR CombineLatestFunc<T1, T2, T3, T4, T5, T6, T7, TR>(
        T1 arg1,
        T2 arg2,
        T3 arg3,
        T4 arg4,
    ...
    internal class CombineLatestObservable<TLeft, TRight, TResult> : OperatorObservableBase<TResult> {
        ...
        class CombineLatest : OperatorObserverBase<TResult, TResult> {
            ...
            class LeftObserver : IObserver<TLeft> {
                ...
                public LeftObserver(CombineLatest parent) { this.parent = parent; }
            ...
            class RightObserver : IObserver<TRight> {
                ...
                public RightObserver(CombineLatest parent) { this.parent = parent; }
            ...
            public CombineLatest(CombineLatestObservable<TLeft, TRight, TResult> parent,
            ...
            public override void OnNext(TResult value) { observer.OnNext(value); }
        ...
        public CombineLatestObservable(IObservable<TLeft> left,
    ...
    internal class CombineLatestObservable<T> : OperatorObservableBase<IList<T>> {
        ...
        class CombineLatest : OperatorObserverBase<IList<T>, IList<T>> {
            ...
            public override void OnNext(IList<T> value) { observer.OnNext(value); }
        ...
        public CombineLatestObservable(IObservable<T>[] sources) : base(true) { this.sources = sources; }
    ...
    internal class CombineLatestObservable<T1, T2, T3, TR> : OperatorObservableBase<TR> {
        ...
        class CombineLatest : NthCombineLatestObserverBase<TR> {
            ...
            public CombineLatest(int length,
                                 CombineLatestObservable<T1, T2, T3, TR> parent,
                                 IObserver<TR> observer,
                                 IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
            ...
            public override TR GetResult() { return parent.resultSelector(c1.Value, c2.Value, c3.Value); }

            public override void OnNext(TR value) { observer.OnNext(value); }
        ...
        public CombineLatestObservable(IObservable<T1> source1,
                                       ...
                                       CombineLatestFunc<T1, T2, T3, TR> resultSelector)
            : base(
                source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread()
                    || source3.IsRequiredSubscribeOnCurrentThread() || false) {
    ...
    internal class CombineLatestObservable<T1, T2, T3, T4, TR> : OperatorObservableBase<TR> {
        ...
        class CombineLatest : NthCombineLatestObserverBase<TR> {
            ...
            public CombineLatest(int length,
                                 CombineLatestObservable<T1, T2, T3, T4, TR> parent,
                                 IObserver<TR> observer,
                                 IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
            ...
            public override TR GetResult() { return parent.resultSelector(c1.Value, c2.Value, c3.Value, c4.Value); }
        ...
        public CombineLatestObservable(IObservable<T1> source1,
            ...
            : base(
                source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread()
                    || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread()
                    || false) {
            this.source1 = source1;
            this.source2 = source2;
            this.source3 = source3;
    ...
    internal class CombineLatestObservable<T1, T2, T3, T4, T5, TR> : OperatorObservableBase<TR> {
        ...
        class CombineLatest : NthCombineLatestObserverBase<TR> {
            ...
            public CombineLatest(int length,
                                 CombineLatestObservable<T1, T2, T3, T4, T5, TR> parent,
                                 IObserver<TR> observer,
                                 IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
        ...
        public CombineLatestObservable(IObservable<T1> source1,
            ...
            : base(
                source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread()
                    || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread()
                    || source5.IsRequiredSubscribeOnCurrentThread() || false) {
            this.source1 = source1;
            this.source2 = source2;
            this.source3 = source3;
            this.source4 = source4;
    ...
    internal class CombineLatestObservable<T1, T2, T3, T4, T5, T6, TR> : OperatorObservableBase<TR> {
        ...
        class CombineLatest : NthCombineLatestObserverBase<TR> {
            ...
            public CombineLatest(int length,
                                 CombineLatestObservable<T1, T2, T3, T4, T5, T6, TR> parent,
                                 IObserver<TR> observer,
                                 IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
        ...
        public CombineLatestObservable(IObservable<T1> source1,
            ...
            : base(
                source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread()
                    || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread()
                    || source5.IsRequiredSubscribeOnCurrentThread() || source6.IsRequiredSubscribeOnCurrentThread()
                    || false) {
            this.source1 = source1;
            this.source2 = source2;
            this.source3 = source3;
    ...
    internal class CombineLatestObservable<T1, T2, T3, T4, T5, T6, T7, TR> : OperatorObservableBase<TR> {
        ...
        class CombineLatest : NthCombineLatestObserverBase<TR> {
            ...
            public CombineLatest(int length,
                                 CombineLatestObservable<T1, T2, T3, T4, T5, T6, T7, TR> parent,
                                 IObserver<TR> observer,
                                 IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
        ...
        public CombineLatestObservable(IObservable<T1> source1,
            ...
            : base(
                source1.IsRequiredSubscribeOnCurrentThread() || source2.IsRequiredSubscribeOnCurrentThread()
                    || source3.IsRequiredSubscribeOnCurrentThread() || source4.IsRequiredSubscribeOnCurrentThread()
                    || source5.IsRequiredSubscribeOnCurrentThread() || source6.IsRequiredSubscribeOnCurrentThread()
                    || source7.IsRequiredSubscribeOnCurrentThread() || false) {
            this.source1 = source1;
            this.source2 = source2;
            this.source3 = source3;
            this.source4 = source4;
