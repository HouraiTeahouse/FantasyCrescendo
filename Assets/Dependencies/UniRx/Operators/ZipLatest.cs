...
namespace UniRx.Operators {
    ...
    public delegate TR ZipLatestFunc<T1, T2, T3, T4, T5, T6, T7, TR>(
        T1 arg1,
        T2 arg2,
        T3 arg3,
        T4 arg4,
    ...
    internal class ZipLatestObservable<TLeft, TRight, TResult> : OperatorObservableBase<TResult> {
        ...
        class ZipLatest : OperatorObserverBase<TResult, TResult> {
            ...
            class LeftObserver : IObserver<TLeft> {
                ...
                public LeftObserver(ZipLatest parent) { this.parent = parent; }
            ...
            class RightObserver : IObserver<TRight> {
                ...
                public RightObserver(ZipLatest parent) { this.parent = parent; }
            ...
            public ZipLatest(ZipLatestObservable<TLeft, TRight, TResult> parent,
        ...
        public ZipLatestObservable(IObservable<TLeft> left,
    ...
    internal class ZipLatestObservable<T> : OperatorObservableBase<IList<T>> {
        ...
        public ZipLatestObservable(IObservable<T>[] sources) : base(true) { this.sources = sources; }
    ...
    internal class ZipLatestObservable<T1, T2, T3, TR> : OperatorObservableBase<TR> {
        ...
        class ZipLatest : NthZipLatestObserverBase<TR> {
            ...
            public ZipLatest(int length,
                             ZipLatestObservable<T1, T2, T3, TR> parent,
    ...
    internal class ZipLatestObservable<T1, T2, T3, T4, TR> : OperatorObservableBase<TR> {
        ...
        class ZipLatest : NthZipLatestObserverBase<TR> {
            ...
            public ZipLatest(int length,
                             ZipLatestObservable<T1, T2, T3, T4, TR> parent,
                             IObserver<TR> observer,
                             IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
    ...
    internal class ZipLatestObservable<T1, T2, T3, T4, T5, TR> : OperatorObservableBase<TR> {
        ...
        class ZipLatest : NthZipLatestObserverBase<TR> {
            ...
            public ZipLatest(int length,
                             ZipLatestObservable<T1, T2, T3, T4, T5, TR> parent,
                             IObserver<TR> observer,
                             IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
    ...
    internal class ZipLatestObservable<T1, T2, T3, T4, T5, T6, TR> : OperatorObservableBase<TR> {
        ...
        class ZipLatest : NthZipLatestObserverBase<TR> {
            ...
            public ZipLatest(int length,
                             ZipLatestObservable<T1, T2, T3, T4, T5, T6, TR> parent,
                             IObserver<TR> observer,
                             IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
    ...
    internal class ZipLatestObservable<T1, T2, T3, T4, T5, T6, T7, TR> : OperatorObservableBase<TR> {
        ...
        class ZipLatest : NthZipLatestObserverBase<TR> {
            ...
            public ZipLatest(int length,
                             ZipLatestObservable<T1, T2, T3, T4, T5, T6, T7, TR> parent,
                             IObserver<TR> observer,
                             IDisposable cancel) : base(length, observer, cancel) {
                this.parent = parent;
            }
