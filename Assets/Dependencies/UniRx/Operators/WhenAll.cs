...
namespace UniRx.Operators {
    ...
    internal class WhenAllObservable<T> : OperatorObservableBase<T[]> {
        ...
        public WhenAllObservable(IObservable<T>[] sources) : base(false) { this.sources = sources; }

        public WhenAllObservable(IEnumerable<IObservable<T>> sources) : base(false) { sourcesEnumerable = sources; }
    ...
    internal class WhenAllObservable : OperatorObservableBase<Unit> {
        ...
        class WhenAll : OperatorObserverBase<Unit, Unit> {
            ...
            class WhenAllCollectionObserver : IObserver<Unit> {
                ...
                public WhenAllCollectionObserver(WhenAll parent) { this.parent = parent; }
            ...
            public override void OnNext(Unit value) { observer.OnNext(value); }
        ...
        class WhenAll_ : OperatorObserverBase<Unit, Unit> {
            ...
            class WhenAllCollectionObserver : IObserver<Unit> {
                ...
                public WhenAllCollectionObserver(WhenAll_ parent) { this.parent = parent; }
        ...
        public WhenAllObservable(IObservable<Unit>[] sources) : base(false) { this.sources = sources; }

        public WhenAllObservable(IEnumerable<IObservable<Unit>> sources) : base(false) { sourcesEnumerable = sources; }
