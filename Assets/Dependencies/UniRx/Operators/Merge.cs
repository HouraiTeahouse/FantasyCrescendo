    ...
    internal class MergeObservable<T> : OperatorObservableBase<T> {
        ...
        class MergeConcurrentObserver : OperatorObserverBase<IObservable<T>, T> {
            ...
            class Merge : OperatorObserverBase<T, T> {
                ...
                public Merge(MergeConcurrentObserver parent, IDisposable cancel) : base(parent.observer, cancel) {
                    this.parent = parent;
                    this.cancel = cancel;
                }
        ...
        class MergeOuterObserver : OperatorObserverBase<IObservable<T>, T> {
            ...
            class Merge : OperatorObserverBase<T, T> {
                ...
                public Merge(MergeOuterObserver parent, IDisposable cancel) : base(parent.observer, cancel) {
                    this.parent = parent;
                    this.cancel = cancel;
                }
