...
namespace UniRx.Operators {
    ...
    public delegate TR ZipFunc<T1, T2, T3, T4, T5, T6, T7, TR>(
        T1 arg1,
        T2 arg2,
        T3 arg3,
        T4 arg4,
    ...
    internal class ZipObservable<TLeft, TRight, TResult> : OperatorObservableBase<TResult> {
        ...
        class Zip : OperatorObserverBase<TResult, TResult> {
            ...
            class LeftZipObserver : IObserver<TLeft> {
                ...
                public LeftZipObserver(Zip parent) { this.parent = parent; }
            ...
            class RightZipObserver : IObserver<TRight> {
                ...
                public RightZipObserver(Zip parent) { this.parent = parent; }
            ...
            public IDisposable Run() {
                ...
                return StableCompositeDisposable.Create(l,
                    r,
                    Disposable.Create(() => {
                        lock (gate) {
                            leftQ.Clear();
    ...
    internal class ZipObservable<T> : OperatorObservableBase<IList<T>> {
        ...
        public ZipObservable(IObservable<T>[] sources) : base(true) { this.sources = sources; }
    ...
    internal class ZipObservable<T1, T2, T3, TR> : OperatorObservableBase<TR> {
        ...
        class Zip : NthZipObserverBase<TR> {
            ...
            public IDisposable Run() {
                ...
                return StableCompositeDisposable.Create(s1,
                    s2,
                    s3,
                    Disposable.Create(() => {
                        lock (gate) {
            ...
            public override TR GetResult() { return parent.resultSelector(q1.Dequeue(), q2.Dequeue(), q3.Dequeue()); }
    ...
    internal class ZipObservable<T1, T2, T3, T4, T5, T6, TR> : OperatorObservableBase<TR> {
        ...
        class Zip : NthZipObserverBase<TR> {
            ...
            public override TR GetResult() {
                return parent.resultSelector(q1.Dequeue(),
                    q2.Dequeue(),
                    q3.Dequeue(),
                    q4.Dequeue(),
                    q5.Dequeue(),
