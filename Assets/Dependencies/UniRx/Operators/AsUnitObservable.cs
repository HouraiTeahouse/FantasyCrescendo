...
namespace UniRx.Operators {
    ...
    internal class AsUnitObservableObservable<T> : OperatorObservableBase<Unit> {
        ...
        class AsUnitObservable : OperatorObserverBase<T, Unit> {
            ...
            public override void OnNext(T value) { observer.OnNext(Unit.Default); }
        ...
        public AsUnitObservableObservable(IObservable<T> source) : base(source.IsRequiredSubscribeOnCurrentThread()) {
            this.source = source;
        }
