    ...
    internal class WithLatestFromObservable<TLeft, TRight, TResult> : OperatorObservableBase<TResult> {
        ...
        class WithLatestFrom : OperatorObserverBase<TResult, TResult> {
            ...
            class LeftObserver : IObserver<TLeft> {
                ...
                public LeftObserver(WithLatestFrom parent) { this.parent = parent; }
            ...
            class RightObserver : IObserver<TRight> {
                ...
                public void OnCompleted() { selfSubscription.Dispose(); }
            ...
            public WithLatestFrom(WithLatestFromObservable<TLeft, TRight, TResult> parent,
        ...
        public WithLatestFromObservable(IObservable<TLeft> left,
