...
namespace UniRx {
    ...
    public static partial class Observable {
        ...
        /// <summary> witness is for type inference. </summary>
        ...
        /// <summary> Converting .Select(_ => Unit.Default) sequence. </summary>
        ...
        /// <summary> Same as LastOrDefault().AsUnitObservable(). </summary>
