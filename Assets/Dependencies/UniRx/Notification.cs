...
namespace UniRx {
    ...
    /// <typeparam name="TValue"> The type of the elements received by the observer. This type parameter is contravariant. That
    /// is, you can use either the type you specified or any type that is less derived. For more information about covariance
    /// and contravariance, see Covariance and Contravariance in Generics. </typeparam>
    /// <typeparam name="TResult"> The type of the result returned from the observer's notification handlers. This type
    /// parameter is covariant. That is, you can use either the type you specified or any type that is more derived. For more
    /// information about covariance and contravariance, see Covariance and Contravariance in Generics. </typeparam>
    ...
    /// <summary> Indicates the type of a notification. </summary>
    public enum NotificationKind {

        /// <summary> Represents an OnNext notification. </summary>
        OnNext,

        /// <summary> Represents an OnError notification. </summary>
        OnError,

        /// <summary> Represents an OnCompleted notification. </summary>
        OnCompleted
    ...
    public abstract class Notification<T> : IEquatable<Notification<T>> {
        ...
        /// <summary> Represents an OnCompleted notification to an observer. </summary>
        ...
        internal sealed class OnCompletedNotification : Notification<T> {
            ...
            /// <summary> Returns NotificationKind.OnCompleted. </summary>
        ...
        internal sealed class OnErrorNotification : Notification<T> {
            ...
            /// <summary> Returns NotificationKind.OnError. </summary>
            public override NotificationKind Kind {
        ...
        internal sealed class OnNextNotification : Notification<T> {
            ...
            /// <summary> Returns the value of an OnNext notification. </summary>
            public override T Value {
                get { return value; }
            }
            ...
            /// <summary> Returns NotificationKind.OnNext. </summary>
            public override NotificationKind Kind {
        ...
        /// <summary> Default constructor used by derived types. </summary>
        ...
        /// <summary> Returns a value that indicates whether the notification has a value. </summary>
        ...
        /// <summary> Determines whether the current Notification&lt;T&gt; object has the same observer message payload as a
        /// specified Notification&lt;T&gt; value. </summary>
        ...
        /// <remarks> Equality of Notification&lt;T&gt; objects is based on the equality of the observer message payload they
        /// represent, including the notification Kind and the Value or Exception (if any). This means two Notification&lt;T&gt;
        /// objects can be equal even though they don't represent the same observer method call, but have the same Kind and have
        /// equal parameters passed to the observer method. In case one wants to determine whether two Notification&lt;T&gt;
        /// objects represent the same observer method call, use Object.ReferenceEquals identity equality instead. </remarks>
        public abstract bool Equals(Notification<T> other);

        /// <summary> Determines whether the two specified Notification&lt;T&gt; objects have the same observer message payload. </summary>
        ...
        /// <returns> true if the first Notification&lt;T&gt; value has the same observer message payload as the second
        /// Notification&lt;T&gt; value; otherwise, false. </returns>
        /// <remarks> Equality of Notification&lt;T&gt; objects is based on the equality of the observer message payload they
        /// represent, including the notification Kind and the Value or Exception (if any). This means two Notification&lt;T&gt;
        /// objects can be equal even though they don't represent the same observer method call, but have the same Kind and have
        /// equal parameters passed to the observer method. In case one wants to determine whether two Notification&lt;T&gt;
        ...
        /// <summary> Determines whether the two specified Notification&lt;T&gt; objects have a different observer message payload. </summary>
        /// <param name="left"> The first Notification&lt;T&gt; to compare, or null. </param>
        /// <param name="right"> The second Notification&lt;T&gt; to compare, or null. </param>
        /// <returns> true if the first Notification&lt;T&gt; value has a different observer message payload as the second
        /// Notification&lt;T&gt; value; otherwise, false. </returns>
        /// <remarks> Equality of Notification&lt;T&gt; objects is based on the equality of the observer message payload they
        /// represent, including the notification Kind and the Value or Exception (if any). This means two Notification&lt;T&gt;
        /// objects can be equal even though they don't represent the same observer method call, but have the same Kind and have
        /// equal parameters passed to the observer method. In case one wants to determine whether two Notification&lt;T&gt;
        /// objects represent a different observer method call, use Object.ReferenceEquals identity equality instead. </remarks>
        public static bool operator !=(Notification<T> left, Notification<T> right) {
            return !(left == right);
        }

        /// <summary> Determines whether the specified System.Object is equal to the current Notification&lt;T&gt;. </summary>
        ...
        /// <param name="onCompleted"> Delegate to invoke for an OnCompleted notification. </param>
        /// <returns> Result produced by the observation. </returns>
        public abstract TResult Accept<TResult>(Func<T, TResult> onNext,
                                                Func<Exception, TResult> onError,
                                                Func<TResult> onCompleted);

        /// <summary> Returns an observable sequence with a single notification, using the immediate scheduler. </summary>
        ...
        /// <summary> Returns an observable sequence with a single notification. </summary>
    ...
    /// <summary> Provides a set of static methods for constructing notifications. </summary>
    public static class Notification {

        /// <summary> Creates an object that represents an OnNext notification to an observer. </summary>
        /// <typeparam name="T"> The type of the elements received by the observer. Upon dematerialization of the notifications
        /// into an observable sequence, this type is used as the element type for the sequence. </typeparam>
        ...
        /// <summary> Creates an object that represents an OnError notification to an observer. </summary>
        /// <typeparam name="T"> The type of the elements received by the observer. Upon dematerialization of the notifications
        /// into an observable sequence, this type is used as the element type for the sequence. </typeparam>
        ...
        /// <summary> Creates an object that represents an OnCompleted notification to an observer. </summary>
        /// <typeparam name="T"> The type of the elements received by the observer. Upon dematerialization of the notifications
        /// into an observable sequence, this type is used as the element type for the sequence. </typeparam>
