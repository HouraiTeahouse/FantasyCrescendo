...
namespace UniRx {
    ...
    /// <summary> Represents value with a timestamp on it. The timestamp typically represents the time the value was received,
    /// using an IScheduler's clock to obtain the current time. </summary>
    ...
    public struct Timestamped<T> : IEquatable<Timestamped<T>> {
        ...
        /// <summary> Determines whether the current Timestamped&lt;T&gt; value has the same Value and Timestamp as a specified
        /// Timestamped&lt;T&gt; value. </summary>
        ...
        /// <summary> Determines whether the two specified Timestamped&lt;T&gt; values have the same Value and Timestamp. </summary>
        ...
        /// <returns> true if the first Timestamped&lt;T&gt; value has the same Value and Timestamp as the second Timestamped&lt;T
        /// &gt; value; otherwise, false. </returns>
        public static bool operator ==(Timestamped<T> first, Timestamped<T> second) {
            return first.Equals(second);
        }

        /// <summary> Determines whether the two specified Timestamped&lt;T&gt; values don't have the same Value and Timestamp. </summary>
        /// <param name="first"> The first Timestamped&lt;T&gt; value to compare. </param>
        /// <param name="second"> The second Timestamped&lt;T&gt; value to compare. </param>
        /// <returns> true if the first Timestamped&lt;T&gt; value has a different Value or Timestamp as the second Timestamped&lt;
        /// T&gt; value; otherwise, false. </returns>
        public static bool operator !=(Timestamped<T> first, Timestamped<T> second) {
            return !first.Equals(second);
        }

        /// <summary> Determines whether the specified System.Object is equal to the current Timestamped&lt;T&gt;. </summary>
        ...
        /// <summary> Returns the hash code for the current Timestamped&lt;T&gt; value. </summary>
        ...
        /// <summary> Returns a string representation of the current Timestamped&lt;T&gt; value. </summary>
    ...
    /// <summary> A helper class with a factory method for creating Timestamped&lt;T&gt; instances. </summary>
    public static class Timestamped {

        /// <summary> Creates an instance of a Timestamped&lt;T&gt;.  This is syntactic sugar that uses type inference to avoid
        /// specifying a type in a constructor call, which is very useful when using anonymous types. </summary>
        /// <param name="value"> The value to be annotated with a timestamp. </param>
        /// <param name="timestamp"> Timestamp associated with the value. </param>
