...
namespace UniRx {
    ...
    public static partial class Observable {
        ...
        /// <summary> Create anonymous observable. Observer has exception durability. This is recommended for make operator and
        /// event like generator. </summary>
        ...
        /// <summary> Create anonymous observable. Observer has exception durability. This is recommended for make operator and
        /// event like generator(HotObservable). </summary>
        public static IObservable<T> Create<T>(Func<IObserver<T>, IDisposable> subscribe,
        ...
        /// <summary> Create anonymous observable. Safe means auto detach when error raised in onNext pipeline. This is recommended
        /// for make generator (ColdObservable). </summary>
        ...
        /// <summary> Empty Observable. Returns only OnCompleted. </summary>
        public static IObservable<T> Empty<T>() {
            return Empty<T>(Scheduler.DefaultSchedulers.ConstantTimeOperations);
        }

        /// <summary> Empty Observable. Returns only OnCompleted on specified scheduler. </summary>
        ...
        /// <summary> Empty Observable. Returns only OnCompleted. witness is for type inference. </summary>
        public static IObservable<T> Empty<T>(T witness) {
            return Empty<T>(Scheduler.DefaultSchedulers.ConstantTimeOperations);
        }

        /// <summary> Empty Observable. Returns only OnCompleted on specified scheduler. witness is for type inference. </summary>
        public static IObservable<T> Empty<T>(IScheduler scheduler, T witness) {
            return Empty<T>(scheduler);
        }

        /// <summary> Non-Terminating Observable. It's no returns, never finish. </summary>
        public static IObservable<T> Never<T>() {
            return ImmutableNeverObservable<T>.Instance;
        }

        /// <summary> Non-Terminating Observable. It's no returns, never finish. witness is for type inference. </summary>
        public static IObservable<T> Never<T>(T witness) {
            return ImmutableNeverObservable<T>.Instance;
        }

        /// <summary> Return single sequence Immediately. </summary>
        public static IObservable<T> Return<T>(T value) {
            return Return<T>(value, Scheduler.DefaultSchedulers.ConstantTimeOperations);
        }

        /// <summary> Return single sequence on specified scheduler. </summary>
        ...
        /// <summary> Return single sequence Immediately, optimized for Unit(no allocate memory). </summary>
        public static IObservable<Unit> Return(Unit value) {
            return ImmutableReturnUnitObservable.Instance;
        }

        /// <summary> Return single sequence Immediately, optimized for Boolean(no allocate memory). </summary>
        ...
        /// <summary> Same as Observable.Return(Unit.Default); but no allocate memory. </summary>
        public static IObservable<Unit> ReturnUnit() {
            return ImmutableReturnUnitObservable.Instance;
        }

        /// <summary> Empty Observable. Returns only onError. </summary>
        ...
        /// <summary> Empty Observable. Returns only onError. witness if for Type inference. </summary>
        public static IObservable<T> Throw<T>(Exception error, T witness) {
            return Throw<T>(error, Scheduler.DefaultSchedulers.ConstantTimeOperations);
        }

        /// <summary> Empty Observable. Returns only onError on specified scheduler. </summary>
        public static IObservable<T> Throw<T>(Exception error, IScheduler scheduler) {
            return new ThrowObservable<T>(error, scheduler);
        }

        /// <summary> Empty Observable. Returns only onError on specified scheduler. witness if for Type inference. </summary>
        ...
        public static IObservable<T> Repeat<T>(T value) { return Repeat(value, Scheduler.DefaultSchedulers.Iteration); }
        ...
        public static IObservable<T> Repeat<T>(this IObservable<T> source) { return RepeatInfinite(source).Concat(); }
        ...
        /// <summary> Same as Repeat() but if arriving contiguous "OnComplete" Repeat stops. </summary>
