...
namespace UniRx {
    ...
    public struct Pair<T> : IEquatable<Pair<T>> {
        ...
        public bool Equals(Pair<T> other) {
            ...
            return comparer.Equals(previous, other.Previous) && comparer.Equals(current, other.Current);
        }

        public override string ToString() { return string.Format("({0}, {1})", previous, current); }
