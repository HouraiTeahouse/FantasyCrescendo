...
namespace UniRx {
    ...
    /// <summary> Notify event of count flag. </summary>
    public class CountNotifier : IObservable<CountChangedStatus> {
        ...
        /// <summary> Setup max count of signal. </summary>
        ...
        /// <summary> Increment count and notify status. </summary>
        ...
        /// <summary> Decrement count and notify status. </summary>
