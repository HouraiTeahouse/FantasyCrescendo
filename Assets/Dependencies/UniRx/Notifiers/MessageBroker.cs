...
namespace UniRx {
    ...
    public interface IMessagePublisher {
        ...
        /// <summary> Send Message to all receiver. </summary>
    ...
    public interface IMessageReceiver {
        ...
        /// <summary> Subscribe typed message. </summary>
    ...
    public interface IAsyncMessagePublisher {
        ...
        /// <summary> Send Message to all receiver and await complete. </summary>
    ...
    /// <summary> In-Memory PubSub filtered by Type. </summary>
    public class MessageBroker : IMessageBroker, IDisposable {

        /// <summary> MessageBroker in Global scope. </summary>
    ...
    public class AsyncMessageBroker : IAsyncMessageBroker, IDisposable {
        ...
        /// <summary> AsyncMessageBroker in Global scope. </summary>
        ...
        public IDisposable Subscribe<T>(Func<T, IObservable<Unit>> asyncMessageReceiver) {
            lock (notifiers) {
                ...
                object _notifier;
                if (!notifiers.TryGetValue(typeof(T), out _notifier)) {
                    ImmutableList<Func<T, IObservable<Unit>>> notifier = ImmutableList<Func<T, IObservable<Unit>>>.Empty;
