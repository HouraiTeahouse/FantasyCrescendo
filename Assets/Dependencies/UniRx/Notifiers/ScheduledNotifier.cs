...
namespace UniRx {
    ...
    /// <summary> Notify value on setuped scheduler. </summary>
    public class ScheduledNotifier<T> : IObservable<T>, IProgress<T> {

        readonly IScheduler scheduler;
        readonly Subject<T> trigger = new Subject<T>();

        /// <summary> Use scheduler is Scheduler.DefaultSchedulers.ConstantTimeOperations. </summary>
        public ScheduledNotifier() { scheduler = Scheduler.DefaultSchedulers.ConstantTimeOperations; }
        ...
        /// <summary> Push value to subscribers on setuped scheduler. </summary>
