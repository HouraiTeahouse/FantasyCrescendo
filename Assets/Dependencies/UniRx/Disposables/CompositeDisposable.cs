...
namespace UniRx {
    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>, IDisposable, ICancelable {
        ...
        /// <summary> Initializes a new instance of the <see cref="T:System.Reactive.Disposables.CompositeDisposable" /> class with
        /// no disposables contained by it initially. </summary>
        public CompositeDisposable() { _disposables = new List<IDisposable>(); }

        /// <summary> Initializes a new instance of the <see cref="T:System.Reactive.Disposables.CompositeDisposable" /> class with
        /// the specified number of disposables. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="T:System.Reactive.Disposables.CompositeDisposable" /> class from
        /// a group of disposables. </summary>
        ...
        /// <summary> Gets the number of disposables contained in the CompositeDisposable. </summary>
        public int Count {
            get { return _count; }
        }

        /// <summary> Adds a disposable to the CompositeDisposable or disposes the disposable if the CompositeDisposable is
        /// disposed. </summary>
        ...
        /// <summary> Removes and disposes the first occurrence of a disposable from the CompositeDisposable. </summary>
        ...
        /// <summary> Removes and disposes all disposables from the CompositeDisposable, but does not dispose the
        /// CompositeDisposable. </summary>
        public void Clear() {
        ...
        /// <summary> Determines whether the CompositeDisposable contains a specific disposable. </summary>
        ...
        /// <summary> Copies the disposables contained in the CompositeDisposable to an array, starting at a particular array
        /// index. </summary>
        /// <param name="array"> Array to copy the contained disposables to. </param>
        /// <param name="arrayIndex"> Target index at which to copy the first disposable of the group. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="array" /> is null. </exception>
        /// <exception cref="ArgumentOutOfRangeException"> <paramref name="arrayIndex" /> is less than zero. -or -
        /// <paramref name="arrayIndex" /> is larger than or equal to the array length. </exception>
        public void CopyTo(IDisposable[] array, int arrayIndex) {
            ...
            lock (_gate) {
                ...
                foreach (IDisposable item in disArray) {
                    if (item != null)
                        disArray.Add(item);
                }
        ...
        /// <summary> Returns an enumerator that iterates through the CompositeDisposable. </summary>
