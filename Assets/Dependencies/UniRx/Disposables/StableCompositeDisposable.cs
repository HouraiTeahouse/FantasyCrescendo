...
namespace UniRx {
    ...
    /// <summary> Represents a group of disposable resources that are disposed together. </summary>
    public abstract class StableCompositeDisposable : ICancelable {
        ...
        class NAry : StableCompositeDisposable {
            ...
            public NAry(IDisposable[] disposables) : this((IEnumerable<IDisposable>) disposables) { }
        ...
        class NAryUnsafe : StableCompositeDisposable {
            ...
            public NAryUnsafe(IDisposable[] disposables) { _disposables = disposables; }
        ...
        class Quaternary : StableCompositeDisposable {
            ...
            public Quaternary(IDisposable disposable1,
        ...
        /// <summary> Disposes all disposables in the group. </summary>
        public abstract void Dispose();

        /// <summary> Gets a value that indicates whether the object is disposed. </summary>
        public abstract bool IsDisposed { get; }

        /// <summary> Creates a new group containing two disposable resources that are disposed together. </summary>
        ...
        /// <summary> Creates a new group containing three disposable resources that are disposed together. </summary>
        /// <param name="disposable1"> The first disposable resoruce to add to the group. </param>
        /// <param name="disposable2"> The second disposable resoruce to add to the group. </param>
        ...
        /// <summary> Creates a new group containing four disposable resources that are disposed together. </summary>
        /// <param name="disposable1"> The first disposable resoruce to add to the group. </param>
        /// <param name="disposable2"> The second disposable resoruce to add to the group. </param>
        ...
        /// <returns> Group of disposable resources that are disposed together. </returns>
        public static ICancelable Create(IDisposable disposable1,
                                         IDisposable disposable2,
                                         IDisposable disposable3,
                                         IDisposable disposable4) {
            if (disposable1 == null)
        ...
        /// <summary> Creates a new group of disposable resources that are disposed together. Array is not copied, it's unsafe but
        /// optimized. </summary>
        /// <param name="disposables"> Disposable resources to add to the group. </param>
        /// <returns> Group of disposable resources that are disposed together. </returns>
