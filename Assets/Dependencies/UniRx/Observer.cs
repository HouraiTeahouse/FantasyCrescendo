...
namespace UniRx {
    ...
    public static class Observer {
        ...
        internal static IObserver<T> CreateSubscribeObserver<T>(Action<T> onNext,
        ...
        internal static IObserver<T> CreateSubscribeWithStateObserver<T, TState>(TState state,
                                                                                 Action<T, TState> onNext,
                                                                                 Action<Exception, TState> onError,
                                                                                 Action<TState> onCompleted) {
        ...
        public static IObserver<T> Create<T>(Action<T> onNext) { return Create<T>(onNext, Stubs.Throw, Stubs.Nop); }
    ...
    public static partial class ObservableExtensions {
        ...
        public static IDisposable SubscribeWithState<T, TState>(this IObservable<T> source,
                                                                ...
                                                                Action<T, TState> onNext) {
            return
                source.Subscribe(Observer.CreateSubscribeWithStateObserver(state,
                    onNext,
                    Stubs<TState>.Throw,
                    Stubs<TState>.Ignore));
        }
        ...
        public static IDisposable SubscribeWithState2<T, TState1, TState2>(this IObservable<T> source,
                                                                           TState1 state1,
                                                                           TState2 state2,
                                                                           Action<T, TState1, TState2> onNext) {
            return
                source.Subscribe(Observer.CreateSubscribeWithState2Observer(state1,
                    state2,
                    onNext,
        ...
        public static IDisposable SubscribeWithState3<T, TState1, TState2, TState3>(this IObservable<T> source,
                                                                                    ...
                                                                                    Action<T, TState1, TState2, TState3>
                                                                                        onNext) {
            return
                source.Subscribe(Observer.CreateSubscribeWithState3Observer(state1,
                    state2,
                    state3,
                    onNext,
    ...
    internal static class Stubs {
        ...
        public static IObservable<TSource> CatchIgnore<TSource>(Exception ex) { return Observable.Empty<TSource>(); }
