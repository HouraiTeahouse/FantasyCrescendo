...
namespace UniRx.InternalUtil {
    ...
    /// <summary> Abstract base class for scheduled work items. </summary>
    internal class ScheduledItem : IComparable<ScheduledItem> {
        ...
        /// <summary> Creates a new scheduled work item to run at the specified time. </summary>
        ...
        /// <summary> Gets the absolute time at which the item is due for invocation. </summary>
        ...
        /// <summary> Gets whether the work item has received a cancellation request. </summary>
        public bool IsCanceled {
            get { return _disposable.IsDisposed; }
        }

        /// <summary> Invokes the work item. </summary>
        public void Invoke() {
        ...
        /// <summary> Compares the work item with another work item based on absolute time values. </summary>
        ...
        /// <remarks> The inequality operators are overloaded to provide results consistent with the IComparable implementation.
        /// Equality operators implement traditional reference equality semantics. </remarks>
        ...
        /// <summary> Determines whether one specified ScheduledItem&lt;TAbsolute&gt; object is due before a second specified
        /// ScheduledItem&lt;TAbsolute&gt; object. </summary>
        ...
        /// <summary> Determines whether one specified ScheduledItem&lt;TAbsolute&gt; object is due before or at the same of a
        /// second specified ScheduledItem&lt;TAbsolute&gt; object. </summary>
        /// <param name="left"> The first object to compare. </param>
        /// <param name="right"> The second object to compare. </param>
        /// <returns> true if the DueTime value of left is earlier than or simultaneous with the DueTime value of right; otherwise,
        /// false. </returns>
        /// <remarks> This operator provides results consistent with the IComparable implementation. </remarks>
        public static bool operator <=(ScheduledItem left, ScheduledItem right) {
            return left.CompareTo(right) <= 0;
        ...
        /// <summary> Determines whether one specified ScheduledItem&lt;TAbsolute&gt; object is due after a second specified
        /// ScheduledItem&lt;TAbsolute&gt; object. </summary>
        /// <param name="left"> The first object to compare. </param>
        /// <param name="right"> The second object to compare. </param>
        ...
        /// <summary> Determines whether one specified ScheduledItem&lt;TAbsolute&gt; object is due after or at the same time of a
        /// second specified ScheduledItem&lt;TAbsolute&gt; object. </summary>
        /// <param name="left"> The first object to compare. </param>
        /// <param name="right"> The second object to compare. </param>
        /// <returns> true if the DueTime value of left is later than or simultaneous with the DueTime value of right; otherwise,
        /// false. </returns>
        /// <remarks> This operator provides results consistent with the IComparable implementation. </remarks>
        public static bool operator >=(ScheduledItem left, ScheduledItem right) {
            return left.CompareTo(right) >= 0;
        ...
        /// <summary> Determines whether two specified ScheduledItem&lt;TAbsolute, TValue&gt; objects are equal. </summary>
        /// <param name="left"> The first object to compare. </param>
        /// <param name="right"> The second object to compare. </param>
        /// <returns> true if both ScheduledItem&lt;TAbsolute, TValue&gt; are equal; otherwise, false. </returns>
        /// <remarks> This operator does not provide results consistent with the IComparable implementation. Instead, it implements
        /// reference equality. </remarks>
        public static bool operator ==(ScheduledItem left, ScheduledItem right) {
            return ReferenceEquals(left, right);
        }

        /// <summary> Determines whether two specified ScheduledItem&lt;TAbsolute, TValue&gt; objects are inequal. </summary>
        /// <param name="left"> The first object to compare. </param>
        /// <param name="right"> The second object to compare. </param>
        ...
        /// <summary> Determines whether a ScheduledItem&lt;TAbsolute&gt; object is equal to the specified object. </summary>
        /// <param name="obj"> The object to compare to the current ScheduledItem&lt;TAbsolute&gt; object. </param>
        /// <returns> true if the obj parameter is a ScheduledItem&lt;TAbsolute&gt; object and is equal to the current
        /// ScheduledItem&lt;TAbsolute&gt; object; otherwise, false. </returns>
        public override bool Equals(object obj) {
            return ReferenceEquals(this, obj);
        }

        /// <summary> Returns the hash code for the current ScheduledItem&lt;TAbsolute&gt; object. </summary>
    ...
    internal class SchedulerQueue {
        ...
        /// <summary> Creates a new scheduler queue with a default initial capacity. </summary>
        public SchedulerQueue() : this(1024) {
        }

        /// <summary> Creats a new scheduler queue with the specified initial capacity. </summary>
