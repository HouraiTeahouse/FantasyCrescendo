...
namespace UniRx {
    ...
    public static class Tuple {
        ...
        public static Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8>> Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1 item1,
                                                                                                          ...
                                                                                                          T7 item7,
                                                                                                          T8 item8) {
            return new Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8>>(item1,
                item2,
                item3,
                item4,
                item5,
        ...
        public static Tuple<T1, T2, T3, T4, T5, T6, T7> Create<T1, T2, T3, T4, T5, T6, T7>(T1 item1,
                                                                                           T2 item2,
                                                                                           T3 item3,
                                                                                           T4 item4,
                                                                                           T5 item5,
        ...
        public static Tuple<T1, T2, T3, T4, T5> Create<T1, T2, T3, T4, T5>(T1 item1,
                                                                           T2 item2,
                                                                           T3 item3,
                                                                           T4 item4,
                                                                           T5 item5) {
    ...
    public struct Tuple<T1> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple, IEquatable<Tuple<T1>> {
        ...
        public override int GetHashCode() { return EqualityComparer<T1>.Default.GetHashCode(item1); }

        int IStructuralEquatable.GetHashCode(IEqualityComparer comparer) { return comparer.GetHashCode(item1); }

        string ITuple.ToString() { return string.Format("{0}", item1); }

        public override string ToString() { return "(" + ((ITuple) this).ToString() + ")"; }

        public bool Equals(Tuple<T1> other) { return EqualityComparer<T1>.Default.Equals(item1, other.item1); }
    ...
    public struct Tuple<T1, T2> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        string ITuple.ToString() { return string.Format("{0}, {1}", item1, item2); }
    ...
    public struct Tuple<T1, T2, T3> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        string ITuple.ToString() { return string.Format("{0}, {1}, {2}", item1, item2, item3); }
    ...
    public struct Tuple<T1, T2, T3, T4> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        string ITuple.ToString() { return string.Format("{0}, {1}, {2}, {3}", item1, item2, item3, item4); }
        ...
        public bool Equals(Tuple<T1, T2, T3, T4> other) {
            ...
            return comparer1.Equals(item1, other.item1) && comparer2.Equals(item2, other.item2)
                && comparer3.Equals(item3, other.item3) && comparer4.Equals(item4, other.item4);
        }
    ...
    public struct Tuple<T1, T2, T3, T4, T5> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) {
            ...
            return comparer.Equals(item1, t.item1) && comparer.Equals(item2, t.item2) && comparer.Equals(item3, t.item3)
                && comparer.Equals(item4, t.item4) && comparer.Equals(item5, t.item5);
        }
        ...
        public override int GetHashCode() {
            ...
            EqualityComparer<T3> comparer3 = EqualityComparer<T3>.Default;
            EqualityComparer<T4> comparer4 = EqualityComparer<T4>.Default;
            EqualityComparer<T5> comparer5 = EqualityComparer<T5>.Default;
        ...
        string ITuple.ToString() { return string.Format("{0}, {1}, {2}, {3}, {4}", item1, item2, item3, item4, item5); }
    ...
    public struct Tuple<T1, T2, T3, T4, T5, T6> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) {
            ...
            return comparer.Equals(item1, t.item1) && comparer.Equals(item2, t.item2) && comparer.Equals(item3, t.item3)
                && comparer.Equals(item4, t.item4) && comparer.Equals(item5, t.item5) && comparer.Equals(item6, t.item6);
        }
        ...
        public override int GetHashCode() {
            ...
            EqualityComparer<T4> comparer4 = EqualityComparer<T4>.Default;
            EqualityComparer<T5> comparer5 = EqualityComparer<T5>.Default;
            EqualityComparer<T6> comparer6 = EqualityComparer<T6>.Default;
        ...
        public bool Equals(Tuple<T1, T2, T3, T4, T5, T6> other) {
            ...
            return comparer1.Equals(item1, other.Item1) && comparer2.Equals(item2, other.Item2)
                && comparer3.Equals(item3, other.Item3) && comparer4.Equals(item4, other.Item4)
                && comparer5.Equals(item5, other.Item5) && comparer6.Equals(item6, other.Item6);
        }
    ...
    public struct Tuple<T1, T2, T3, T4, T5, T6, T7> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple,
        ...
        public override int GetHashCode() {
            ...
            EqualityComparer<T5> comparer5 = EqualityComparer<T5>.Default;
            EqualityComparer<T6> comparer6 = EqualityComparer<T6>.Default;
            EqualityComparer<T7> comparer7 = EqualityComparer<T7>.Default;
    ...
    public partial class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IStructuralEquatable, IStructuralComparable,
                                                                    IComparable, ITuple,
                                                                    IEquatable<Tuple<T1, T2, T3, T4, T5, T6, T7, TRest>> {
        ...
        public bool Equals(Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> other) {
            ...
            EqualityComparer<T6> comparer6 = EqualityComparer<T6>.Default;
            EqualityComparer<T7> comparer7 = EqualityComparer<T7>.Default;
            EqualityComparer<TRest> comparer8 = EqualityComparer<TRest>.Default;

            return comparer1.Equals(item1, other.Item1) && comparer2.Equals(item2, other.Item2)
                && comparer3.Equals(item3, other.Item3) && comparer4.Equals(item4, other.Item4)
                && comparer5.Equals(item5, other.Item5) && comparer6.Equals(item6, other.Item6)
                && comparer7.Equals(item7, other.Item7) && comparer8.Equals(rest, other.rest);
        }
        ...
        bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) {
            ...
            return comparer.Equals(item1, t.item1) && comparer.Equals(item2, t.item2) && comparer.Equals(item3, t.item3)
                && comparer.Equals(item4, t.item4) && comparer.Equals(item5, t.item5) && comparer.Equals(item6, t.item6)
                && comparer.Equals(item7, t.item7) && comparer.Equals(rest, t.rest);
        }
