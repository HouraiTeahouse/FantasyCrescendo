...
namespace UnityEngine.UI
{
    public class CharacterSlotLayout : LayoutGroup
    {
        ...
        [SerializeField]
        protected Origin MStartOrigin = Origin.UpperLeft;
        public Origin StartOrigin { get { return MStartOrigin; } set { SetProperty(ref MStartOrigin, value); } }
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            int cornerX = (int)StartOrigin % 2;
            int cornerY = (int)StartOrigin / 2;
