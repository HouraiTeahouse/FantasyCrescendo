    ...
    public class PlayerPointer : PlayerUIComponent {
        ...
        void Update() {
            ...
            Bounds bounds = new Bounds(Vector3.zero,
                (_rTransform.parent as RectTransform).rect.size - 0.5f * _rTransform.sizeDelta);
            _rTransform.anchoredPosition =
                bounds.ClosestPoint(_rTransform.anchoredPosition + _movementSpeed * movement * Time.deltaTime);
        }
    }
}