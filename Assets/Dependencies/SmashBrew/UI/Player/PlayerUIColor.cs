...
namespace HouraiTeahouse.SmashBrew.UI {
    ...
    public sealed class PlayerUIColor : CharacterUIComponent<Graphic> {
        ...
        [SerializeField, Range(0f, 1f), Tooltip("The change in the color's value")] private float _value = 1f;

        [SerializeField, Range(0f, 1f), Tooltip("The change in alpha")] private float _alpha = 1f;

        [SerializeField, Tooltip("The alpha blend stylej")] private AlphaBlend _alphaBlend;

        [SerializeField, Tooltip("The red channel color correction curve")] private AnimationCurve _red =
            AnimationCurve.Linear(0, 0, 1f, 1f);

        [SerializeField, Tooltip("The blue channel color correction curve")] private AnimationCurve _blue =
            AnimationCurve.Linear(0, 0, 1f, 1f);

        [SerializeField, Tooltip("The green channel color correction curve")] private AnimationCurve _green =
            AnimationCurve.Linear(0, 0, 1f, 1f);
