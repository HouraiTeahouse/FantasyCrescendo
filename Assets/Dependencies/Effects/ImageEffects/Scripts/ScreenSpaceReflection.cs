    ...
    public class ScreenSpaceReflection : PostEffectsBase {
        ...
        public void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            ssrMaterial.SetVector("_SourceToTempUV",
                new Vector4(sourceToTempUV.x, sourceToTempUV.y, 1.0f / sourceToTempUV.x, 1.0f / sourceToTempUV.y));
            ...
            float pixelsPerMeterAtOneMeter = sWidth
                / (-2.0f * (float) Math.Tan(GetComponent<Camera>().fieldOfView / 180.0 * Math.PI * 0.5));
            ...
            var invScreenSize = new Vector2((float) (1.0 / (double) Screen.width),
            ...
            RenderTexture averageRayDistanceBuffer = RenderTexture.GetTemporary(source.width,
                source.height,
                0,
            ...
            RenderTexture finalReflectionBuffer =
                RenderTexture.GetTemporary(resolveDiffersFromTraceRes ? source.width : rtW,
            ...
            if (settings.temporalFilterStrength > 0.0) {
                ...
                Graphics.Blit(doTemporalFilterThisFrame ? temporallyFilteredBuffer : finalReflectionBuffer,
