...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class BloomAndFlares : PostEffectsBase {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            RenderTexture secondQuarterRezColor = RenderTexture.GetTemporary(source.width/4,
                                                                             source.height/4,
                                                                             0,
                                                                             rtFormat);
            ...
            for (var iter = 0; iter < bloomBlurIterations; iter++) {
                ...
                separableBlurMaterial.SetVector("offsets",
                                                new Vector4((spreadForPass/widthOverHeight)*oneOverBaseSize,
                                                            0.0f,
                                                            0.0f,
                                                            0.0f));
            ...
            if (lensflares) {
                ...
                // (b) hollywood/anamorphic flares?
                    ...
                    hollywoodFlaresMaterial.SetVector("offsets",
                                                      new Vector4((sepBlurSpread*1.0f/widthOverHeight)*oneOverBaseSize,
                                                                  0.0f,
                                                                  0.0f,
                                                                  0.0f));
