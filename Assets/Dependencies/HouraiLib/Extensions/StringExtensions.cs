...
namespace HouraiTeahouse {
    ...
    public static class StringExtensions {
        ...
        public static T ToEnum<T>(this string str, bool ignoreCase = false) where T : struct, IComparable, IFormattable, IConvertible {
            Check.Argument(str.IsNullOrEmpty());
            return (T) Enum.Parse(typeof (T), Check.NotNull("str", str), ignoreCase);
        }

        /// <summary>
        /// Shorthand for string.With.
        /// </summary>
        ...
        public static string With(this string str, params object[] objs) {
            return string.Format(Check.NotNull("str", str), Check.NotNull("objs", objs));
        }
