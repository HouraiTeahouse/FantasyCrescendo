...
namespace HouraiTeahouse {
    ...
    public static class VectorExtensions {
        ...
        public static Vector2 Mult(this Vector2 a, params Vector2[] b) { return b.Aggregate(a, Vector2.Scale); }

        /// <summary> Computes the Hadamard product between two 3D vectors. </summary>
        /// <param name="a"> the first vector </param>
        /// <param name="b"> the second vector </param>
        /// <returns> the Hadamard product of the two vectors </returns>
        public static Vector3 Mult(this Vector3 a, params Vector3[] b) { return b.Aggregate(a, Vector3.Scale); }

        /// <summary> Computes the Hadamard product between two 4D vectors. </summary>
        /// <param name="a"> the first vector </param>
        /// <param name="b"> the second vector </param>
        /// <returns> the Hadamard product of the two vectors </returns>
        public static Vector4 Mult(this Vector4 a, params Vector4[] b) { return b.Aggregate(a, Vector4.Scale); }
        ...
        /// <param name="v"> the source vector </param>
        /// <returns> the largest componet's value </returns>
        public static float Max(this Vector3 v) { return Mathf.Max(v.x, v.y, v.z); }

        /// <summary> Computes the largest component of a 2D vector. </summary>
        /// <param name="v"> the source vector </param>
        /// <returns> the largest componet's value </returns>
        public static float Max(this Vector4 v) { return Mathf.Max(v.x, v.y, v.z, v.w); }
        ...
        /// <param name="v"> the source vector </param>
        /// <returns> the smallest componet's value </returns>
        public static float Min(this Vector3 v) { return Mathf.Min(v.x, v.y, v.z); }

        /// <summary> Computes the smallest component of a 2D vector. </summary>
        /// <param name="v"> the source vector </param>
        /// <returns> the smallest componet's value </returns>
        public static float Min(this Vector4 v) { return Mathf.Min(v.x, v.y, v.z, v.w); }
