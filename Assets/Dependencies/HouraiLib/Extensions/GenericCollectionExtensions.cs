...
namespace HouraiTeahouse {
    ...
    public static class GenericCollectionExtensions {
        ...
        /// <summary>
        /// Samples one every N elements from an enumeration.
        /// </summary>
        ...
        /// <summary>
        /// Finds the key with the maximum value over an enumeration of key-value pairs.
        /// Note this is not a streaming operator. An infinite enumeration will infinitely loop.
        /// </summary>
        ...
        /// <summary>
        /// Finds the key with the minimum value over an enumeration of key-value pairs.
        /// Note this is not a streaming operator. An infinite enumeration will infinitely loop.
        /// </summary>
        /// <typeparam name="K">the type of of the keys</typeparam>
        /// <typeparam name="V">the type of the values</typeparam>
        ...
        private static K FindArg<K, V>(IEnumerable<KeyValuePair<K, V>> values, Func<V, V, bool> func) {
            ...
            while (iterator.MoveNext()) {
                if (!func(iterator.Current.Value, val)) continue;
        ...
        /// <summary>
        /// Finds the index of the maximum value over an enumeration.
        /// Note this is not a streaming operator. An infinite enumeration will infinitely loop.
        /// </summary>
        ...
        /// <summary>
        /// Finds the index of the minimum value over an enumeration.
        /// Note this is not a streaming operator. An infinite enumeration will infinitely loop.
        /// </summary>
        /// <typeparam name="T">the type of the values being enumerated</typeparam>
        /// <param name="values">the enumeration</param>
        ...
        private static int FindIndex<T>(IEnumerable<T> enumeration, Func<T, T, bool> func) {
            ...
            while (iterator.MoveNext()) {
                i++;
                if (!func(iterator.Current, val)) continue;
                index = i;
