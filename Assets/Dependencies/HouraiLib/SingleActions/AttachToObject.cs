...
namespace HouraiTeahouse {
    ...
    public class AttachToObject : SingleActionBehaviour {
        ...
        [SerializeField, Tooltip("The parent object to attach the child to")]
        private Transform _parent;

        [SerializeField, Tag, Tooltip("The tag to search for if a parent is not provided.")]
        private string _tag;

        [SerializeField, Tooltip("The child to attach to the parent.")]
