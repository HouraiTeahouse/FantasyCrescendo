...
namespace HouraiTeahouse.Editor {
    ...
    public static class SerializedPropertyUtil {
        ...
        /// <summary>
        /// Creates an enumerator for iterating over the array elements in an array.
        /// </summary>
        ...
        public static IEnumerable<SerializedProperty> AsArrayEnumerable(
        ...
        /// <summary>
        /// Adds an element to an array property at a given index and returns the property that was added.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="property"/> is null.</exception>
        /// <exception cref="ArgumentException"><paramref name="property"/> is not an array property 
        /// or <paramref name="index"/> is out of bounds</exception>
        public static SerializedProperty AddElementAtIndex(
            this SerializedProperty property,
            int index) {
            Check.NotNull(property);
        ...
        /// <summary>
        /// Adds an element to an array property at the end and returns the property that was added.
        /// </summary>
        /// <param name="property">the array property</param>
        /// <returns>the SerializedProperty pointing to the array element</returns>
        /// <exception cref="ArgumentNullException"><paramref name="property"/> is null.</exception>
        ...
        /// <summary>
        /// Adds an element to an array property at the beginning and returns the property that was added.
        /// </summary>
        /// <param name="property">the array property</param>
        /// <returns>the SerializedProperty pointing to the array element</returns>
        /// <exception cref="ArgumentNullException"><paramref name="property"/> is null.</exception>
