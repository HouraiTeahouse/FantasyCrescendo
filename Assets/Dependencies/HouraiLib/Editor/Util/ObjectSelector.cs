...
namespace HouraiTeahouse.Editor {
    ...
    /// <summary> Wrapper around EditorGUI.Popup that allows for arbitrary selection of any object. </summary>
    ...
    public class ObjectSelector<T> where T : class {
        ...
        /// <summary> Initializes an instance of ObjectSelector. </summary>
        ...
        /// <summary> Gets or sets the available selectable items. </summary>
        public T[] Selections {
        ...
        /// <summary> Gets all of the generated GUIContent. </summary>
        public GUIContent[] Content { get; private set; }

        /// <summary> Checks if the current state of the selector is valid. Will return true if there are valid selections to use
        /// and false otherwise. </summary>
        public bool IsValid {
            get { return Selections != null; }
        }

        /// <summary> Gets the GUIContent used for the currently selected. If nothing is currently selected or the selector is not
        /// currently valid, will return null. </summary>
        public GUIContent SelectedContent {
            get { return _contentFunc(Selected); }
        }

        /// <summary> Fired every time the selected object changes to a new value. First argument is old value, new argument is new
        /// value. </summary>
        public event Action<T, T> SelectionChanged;

        /// <summary> Attempts to set the selected value. If <paramref name="obj" /> is not found, the selected value will not be
        /// changed </summary>
