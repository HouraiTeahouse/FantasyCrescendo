...
namespace HouraiTeahouse {
    ...
    public static class AnimatorStateExtensions {
        ...
        /// <summary>
        /// Like GetComponent, except for AnimatorStates
        /// A strongly typed 
        /// </summary>
        ...
        public static StateMachineBehaviour GetComponent(
        ...
        /// <summary>
        /// Gets all StateMachineBehaviour that are of a specified type 
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="state"></param>
        /// <returns></returns>
        public static IEnumerable<T> GetBehaviours<T>(this AnimatorState state) {
            return state.behaviours.OfType<T>();
        }
