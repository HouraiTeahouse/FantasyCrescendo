...
namespace InControl
{
	public class XInputDevice : InputDevice
	{
		...
		public override void Update( ulong updateTick, float deltaTime )
		{
			...
			UpdateWithState( InputControlTarget.RightBumper, state.Buttons.RightShoulder == ButtonState.Pressed, updateTick );

			UpdateWithState( InputControlTarget.LeftStickButton, state.Buttons.LeftStick == ButtonState.Pressed, updateTick );
			UpdateWithState( InputControlTarget.RightStickButton, state.Buttons.RightStick == ButtonState.Pressed, updateTick );
