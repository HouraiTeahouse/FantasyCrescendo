    ...
    public class NatecGenesisP44Profile : UnityInputDeviceProfile {
        ...
        public NatecGenesisP44Profile() {
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "L", Target = InputTarget.LeftBumper, Source = Button4},
                new InputMapping {Handle = "R", Target = InputTarget.RightBumper, Source = Button5},
                new InputMapping {Handle = "LL", Target = InputTarget.LeftTrigger, Source = Button6},
                new InputMapping {Handle = "RR", Target = InputTarget.RightTrigger, Source = Button7},
                ...
                new InputMapping {Handle = "Menu", Target = InputTarget.Menu, Source = Button12}
            };
