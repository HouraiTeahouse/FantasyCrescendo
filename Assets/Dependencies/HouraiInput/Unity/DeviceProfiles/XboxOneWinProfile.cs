    ...
    public class XboxOneWinProfile : UnityInputDeviceProfile {
        ...
        public XboxOneWinProfile() {
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "View", Target = InputTarget.View, Source = Button6},
                new InputMapping {Handle = "Menu", Target = InputTarget.Start, Source = Button7}
            };
            ...
            AnalogMappings = new[] {
                ...
                new InputMapping {Handle = "Left Trigger", Target = InputTarget.LeftTrigger, Source = Analog8},
                new InputMapping {Handle = "Right Trigger", Target = InputTarget.RightTrigger, Source = Analog9}
            };
        }
