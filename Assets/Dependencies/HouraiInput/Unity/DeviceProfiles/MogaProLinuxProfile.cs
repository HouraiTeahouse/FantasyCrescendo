    ...
    public class MogaProLinuxProfile : UnityInputDeviceProfile {
        ...
        public MogaProLinuxProfile() {
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "Left Stick Button", Target = InputTarget.LeftStickButton, Source = Button7},
                new InputMapping {
                    Handle = "Right Stick Button",
                    Target = InputTarget.RightStickButton,
                    Source = Button8
                },
                new InputMapping {Handle = "Start", Target = InputTarget.Start, Source = Button6}
            };
            ...
            AnalogMappings = new[] {
                ...
                new InputMapping {Handle = "Left Trigger", Target = InputTarget.LeftTrigger, Source = Analog5,},
                new InputMapping {Handle = "Right Trigger", Target = InputTarget.RightTrigger, Source = Analog4}
            };
        }
