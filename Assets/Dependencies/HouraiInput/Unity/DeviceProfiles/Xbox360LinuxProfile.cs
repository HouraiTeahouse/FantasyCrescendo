    ...
    public class Xbox360LinuxProfile : UnityInputDeviceProfile {
        ...
        public Xbox360LinuxProfile() {
            ...
            ButtonMappings = new[] {
                ...
                new InputMapping {Handle = "DPad Left", Target = InputTarget.DPadLeft, Source = Button11, Invert = true},
                new InputMapping {Handle = "DPad Right", Target = InputTarget.DPadRight, Source = Button12,},
                new InputMapping {Handle = "DPad Up", Target = InputTarget.DPadUp, Source = Button13, Invert = true},
                new InputMapping {Handle = "DPad Down", Target = InputTarget.DPadDown, Source = Button14,},
                new InputMapping {Handle = "Back", Target = InputTarget.Back, Source = Button6},
                new InputMapping {Handle = "Start", Target = InputTarget.Start, Source = Button7},
                new InputMapping {Handle = "Menu", Target = InputTarget.Menu, Source = Button8}
            };
