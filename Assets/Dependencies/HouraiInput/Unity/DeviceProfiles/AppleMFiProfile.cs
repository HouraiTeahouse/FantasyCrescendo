namespace HouraiTeahouse.HouraiInput {
    ...
    public class AppleMFiProfile : UnityInputDeviceProfile {
        ...
        public AppleMFiProfile() {
            ...
            ButtonMappings = new[] {
                new InputMapping {Handle = "A", Target = InputTarget.Action1, Source = Button14},
                new InputMapping {Handle = "B", Target = InputTarget.Action2, Source = Button13},
                new InputMapping {Handle = "X", Target = InputTarget.Action3, Source = Button15},
                new InputMapping {Handle = "Y", Target = InputTarget.Action4, Source = Button12},
                ...
                new InputMapping {Handle = "Left Bumper", Target = InputTarget.LeftBumper, Source = Button8},
                new InputMapping {Handle = "Right Bumper", Target = InputTarget.RightBumper, Source = Button9},
                new InputMapping {Handle = "Pause", Target = InputTarget.Pause, Source = Button0},
