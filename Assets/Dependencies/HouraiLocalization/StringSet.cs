...
namespace HouraiTeahouse.Localization {
    ...
    /// <summary> A simple ScriptableObject that doubles as a set of strings </summary>
    public class StringSet : ScriptableObject, IList<string> {
        ...
        /// <summary> Unity callback. Called after object is loaded. </summary>
        void OnEnable() {
            if (_strings == null)
                _strings = new List<string>();
        }

        /// <summary> Creates a StringSet instance from an enumeration of strings Strings are in the same order they were
        /// enumerated from the enumeration </summary>
        /// <param name="strings"> the enumeration of strings </param>
        /// <returns> a StringSet representing the same set of strings </returns>
        public static StringSet Create(IEnumerable<string> strings) {
            var set = CreateInstance<StringSet>();
            set.Copy(strings);
            return set;
        }

        /// <summary> Copys the values from an enumeration into the StringSet </summary>
        /// <param name="strings"> the enumeration to update from </param>
        public void Copy(IEnumerable<string> strings) {
            _strings = strings == null ? new List<string>() : strings.ToList();
        }
