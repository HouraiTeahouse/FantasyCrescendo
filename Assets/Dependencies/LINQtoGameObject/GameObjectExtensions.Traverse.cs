...
namespace Unity.Linq {
    ...
    public static partial class GameObjectExtensions {
        ...
        public struct AfterSelfEnumerable : IEnumerable<GameObject> {
            ...
            /// <summary> Store element into the buffer, return number is size. array is automaticaly expanded. </summary>
            public int ToArrayNonAlloc<TState, T>(Func<GameObject, TState> let,
                                                  Func<TState, bool> filter,
            ...
            public T[] ToArray<TState, T>(Func<GameObject, TState> let,
                                          Func<TState, bool> filter,
                                          Func<TState, T> selector) {
                var array = new T[4];
            ...
            public struct OfComponentEnumerable<T> : IEnumerable<T> where T : Component {
                ...
                public OfComponentEnumerable(ref AfterSelfEnumerable parent) { this.parent = parent; }

                public OfComponentEnumerator<T> GetEnumerator() { return new OfComponentEnumerator<T>(ref parent); }
        ...
        public struct AncestorsEnumerable : IEnumerable<GameObject> {
            ...
            public struct OfComponentEnumerable<T> : IEnumerable<T> where T : Component {
                ...
                public OfComponentEnumerable(ref AncestorsEnumerable parent) { this.parent = parent; }
        ...
        public struct BeforeSelfEnumerable : IEnumerable<GameObject> {
            ...
            public struct OfComponentEnumerable<T> : IEnumerable<T> where T : Component {
                ...
                public OfComponentEnumerable(ref BeforeSelfEnumerable parent) { this.parent = parent; }
        ...
        public struct ChildrenEnumerable : IEnumerable<GameObject> {
            ...
            public struct OfComponentEnumerable<T> : IEnumerable<T> where T : Component {
                ...
                public OfComponentEnumerable(ref ChildrenEnumerable parent) { this.parent = parent; }
        ...
        public struct DescendantsEnumerable : IEnumerable<GameObject> {
            ...
            void DescendantsCore(ref Func<GameObject, bool> filter,
                                 ref Transform transform,
                                 ref int index,
                                 ref GameObject[] array) {
                int childCount = transform.childCount;
                for (var i = 0; i < childCount; i++) {
                    Transform child = transform.GetChild(i);
            ...
            void DescendantsCore<T>(ref Func<GameObject, T> selector,
                                    ref Transform transform,
                                    ref int index,
                                    ref T[] array) {
                int childCount = transform.childCount;
            ...
            void DescendantsCore<T>(ref Func<GameObject, bool> filter,
                                    ref Func<GameObject, T> selector,
                                    ref Transform transform,
                                    ref int index,
                                    ref T[] array) {
                int childCount = transform.childCount;
            ...
            void DescendantsCore<TState, T>(ref Func<GameObject, TState> let,
                                            ref Func<TState, bool> filter,
                                            ref Func<TState, T> selector,
                                            ref Transform transform,
                                            ref int index,
                                            ref T[] array) {
                int childCount = transform.childCount;
            ...
            internal class InternalUnsafeRefStack {
                ...
                public InternalUnsafeRefStack(int initialStackDepth) { array = new Enumerator[initialStackDepth]; }
            ...
            public struct Enumerator : IEnumerator<GameObject> {
                ...
                internal Enumerator(Transform originTransform,
                                    bool withSelf,
                                    bool canRun,
                                    InternalUnsafeRefStack sharedStack) {
                    this.originTransform = originTransform;
            ...
            public struct OfComponentEnumerable<T> : IEnumerable<T> where T : Component {
                ...
                public OfComponentEnumerable(ref DescendantsEnumerable parent) { this.parent = parent; }
        ...
        /// <summary> Gets the first child GameObject with the specified name. If there is no GameObject with the speficided name,
        /// returns null. </summary>
        public static GameObject Child(this GameObject origin, string name) {
            if (origin == null)
                return null;

            Transform child = origin.transform.FindChild(name); // transform.find can get inactive object
            if (child == null)
                return null;
        ...
        /// <summary> Returns a collection of GameObjects that contain this GameObject, and all descendant GameObjects of this
        /// GameObject. </summary>
        ...
        /// <summary> Returns a collection of GameObjects that contain this GameObject, and the sibling GameObjects before this
        /// GameObject. </summary>
        ...
        /// <summary> Returns a collection of GameObjects that contain this GameObject, and the sibling GameObjects after this
        /// GameObject. </summary>
